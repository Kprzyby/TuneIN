...
const EditPlaylists: React.FC = () => {
  ...
  const [renamePlaylistID, setRenamePlaylistID] = useState<undefined | number>(
    undefined
  );
  ...
  const handleRenamePlaylist = async () => {
    await createDBEndpoint(
      ENDPOINTS.playlists.renamePlaylist + renamePlaylistID
    )
  ...
  return (
    <Styled.Wrapper>
      {(isNewPlaylist || isRenamePlaylist) && (
        ...
        >
          <div
            style={{ display: "flex", flexFlow: "column wrap", gap: "0.5rem" }}
          >
            {isNewPlaylist ? (
              <>
                <input
              ...
              <>
                ...
                <div style={{ display: "flex", flexFlow: "row" }}>
                  ...
                  <Styled.ClearBtn
                    type="button"
                    onClick={() => setIsRenamePlaylist(false)}
                  >
                    <DarkButton text="Cancel" />
                  </Styled.ClearBtn>
                </div>
      ...
      <Styled.Header>
        <div style={{ marginLeft: "-50%", width: "inherit" }}>
          {renderInputBar}
        </div>
        <div
          style={{
          ...
          playlists.map((playlist: PlaylistType, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <PlaylistCard {...playlist} {...{ styled: { isLast } }} />
                </Styled.ClearBtn>
                <div
                  style={{
                    display: "flex",
